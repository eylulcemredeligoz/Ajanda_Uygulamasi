  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      shape: RoundedRectangleBorder(
          borderRadius:
              BorderRadius.circular(20)), //cartın köşelerini yumuşatır
      child: Padding(
          ...
          children: [
            widget.task.type == Tasktype.akademikHayat
                ? Image(
                    ...
                    height: 50,
                  ) //yuvarlak ıconlalr buraya gelicek
            ...
            Checkbox(
              ...
              onChanged: (val) => {
                setState(() {
                  widget.task.setIsCompleted(val!);
                  // widget.task.isCompleted=!widget.task.isCompleted;
                  isChecked =
                      val; //eğer sadece val değişkeni varsa işleme sok (checkboxun çalışıp çalışmaması)
                })
              },
